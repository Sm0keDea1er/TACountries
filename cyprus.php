        ...
        <div class="row justify-content-between">
            ...
            <div class="col-12 col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="list-group-item">
                        <p>На Кипре используются электрические розетки «британского» формата – с тремя отверстиями.  Напряжение сети – 240 Вольт,  с частотой 50Hz.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                    ...
                    <div class="list-group-item">
                        ...
                        <p>Стоит, отметь, что остров Кипр – это не единое государство, крайне нежелательно посещать территории, оккупированные турецкими войсками (две зоны на севере острова), а так же английские военные базы.</p>
                    </div>
                </div>
            </div>
        </div>
